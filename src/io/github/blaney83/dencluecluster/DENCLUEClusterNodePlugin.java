 ...
 */
public class DENCLUEClusterNodePlugin extends Plugin {
    // The shared instance.
    private static DENCLUEClusterNodePlugin plugin;

    /**
     * The constructor.
     */
    public DENCLUEClusterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DENCLUEClusterNodePlugin getDefault() {
        return plugin;
    }
